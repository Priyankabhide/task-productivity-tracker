...
echo "<h2 style='color:white; font-weight:bold; text-align:center; margin-bottom:20px' >Pending Tasks</h2>";

$user_id = $_SESSION['user_id'];
$sql = "SELECT * FROM tasks WHERE completed = 0 AND user_id = '$user_id'"; // Filter by user and pending
...
if ($result->num_rows > 0) {
    ...
    echo "<p style='color:#fff'>No pending tasks found for this user</p>";
}
