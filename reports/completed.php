...
echo "<h2 style='color:white; font-weight:bold; text-align:center; margin-bottom:20px' >Completed Tasks</h2>";

$user_id = $_SESSION['user_id'];
$sql = "SELECT * FROM tasks WHERE completed = 1 AND user_id = '$user_id'";  // Filter by user and completed
...
if ($result->num_rows > 0) {
    ...
    echo "<p style='color:#fff;'>No completed tasks found for this user</p>";
}
